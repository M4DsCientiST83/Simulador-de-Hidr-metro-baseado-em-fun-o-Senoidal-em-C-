...
public class HidrometroDisplay extends JFrame 
{
    ...
    private void loadImages() 
    {
        try 
        {
            // Tenta carregar imagens da base do Hidrometro e dos ponteiros
    ...
    {
        // Inicializa o Thread ser utilizado
    ...
    {
        // Conecta ao servidor através da porta TCP 5000
    ...
    {
        // Processa os dados recebidos através da conexão oriúndos do programa em C++ 
        try 
        {
    ...
    {
        // Inicializa um objeto da Classe HidrometroDisplay para executar o algoritmo
